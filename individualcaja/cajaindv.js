...
function notificarPedido(resultado,callback){
    if(resultado=="listo"){
        callback("pedido listo");
    }else{
        callback("pedido cancelado");
    }}
export{pedidos,agregarPedido,modificarPedido,eliminarPedido,listarPedidos,notificarPedido};
